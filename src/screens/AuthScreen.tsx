...
export default function AuthScreen() {
  ...
  return (
    <div ref={scrollRef} className="w-full h-full relative overflow-y-auto overflow-x-hidden bg-[#0A0A0A] flex flex-col lg:items-center lg:justify-start">
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 'onboarding' && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -50 }}
            className="w-full max-w-[560px] mx-auto min-h-[100dvh] flex flex-col items-center justify-between z-10 px-6 pb-[env(safe-area-inset-bottom,32px)] box-border relative lg:max-w-none lg:w-[100vw] lg:min-h-[100dvh] lg:flex-col lg:items-center lg:pt-0 lg:pb-0 scroll-smooth"
            onTouchStart={handleTouchStart}
            onTouchEnd={handleTouchEnd}
            onScroll={handleScroll}
          >
            {/* Inner Wrapper for max-w on Web */}
            <div className="w-full min-h-full flex flex-col items-center justify-between lg:w-full lg:max-w-[600px] lg:mx-auto lg:px-[24px] lg:pt-[60px] lg:pb-[60px] lg:flex-col lg:items-center lg:gap-[24px] lg:h-max lg:min-h-[100dvh] lg:justify-center flex-1">
              {/* Skip Button */}
              {slideIndex < 2 && (
